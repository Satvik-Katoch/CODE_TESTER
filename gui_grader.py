...
class CppGraderApp(tk.Tk):
    ...
    top-right toggle for switching between the editor and diff viewer.
    """
    def __init__(self):
        super().__init__()
        ...
        # Create the main widgets for both pages
    ...
    def _configure_styles(self):
        ...
        # --- Styles for the new top-right navigation buttons ---
        nav_font = ("Segoe UI", 9)
        ...
        self.style.map("Nav.TButton",
            ...
            background=[
                ('disabled', '#333'),
                ('active', '#5c6370'), # Slightly lighter on click
            ]
        )
        # Style for the currently selected page button
    ...
    def _create_main_layout(self):
        ...
        # --- Create the new top-right navigation toggle ---
        ...
        # --- Create Editor Page Content ---
        self.editor_frame.pack(fill="both", expand=True) # Pack it initially
        ...
        self.cpp_code_text = scrolledtext.ScrolledText(left_frame, wrap=tk.WORD, font=self.code_font, bg="#1E1E1E", fg="#D4D4D4", insertbackground="white", relief=tk.FLAT, borderwidth=0)
        ...
        # Right Pane (Input, Output, Status)
    ...
    def _create_text_area_with_header(self, parent, title, paste_command):
        """Helper to create a frame with a title, an optional paste button, and a text area."""
        ...
        text_widget = scrolledtext.ScrolledText(frame, wrap=tk.WORD, font=self.code_font, bg="#1E1E1E", fg="#D4D4D4", insertbackground="white", relief=tk.FLAT, borderwidth=0)
        text_widget.grid(row=1, column=0, sticky="nsew")
        return frame, text_widget

    def _create_diff_widgets(self):
        """Create and layout all widgets for the diff viewer page."""
    ...
    def show_diff_page(self):
        """Switches the view to the diff page and updates nav styles."""
    ...
    def show_editor_page(self):
        """Switches the view back to the editor page and updates nav styles."""
    ...
    def _update_diff_text(self):
        """Compares the last outputs and populates the diff text widget."""
    ...
    def finalize_ui(self, enable_diff=False):
        def _update():
            ...
            if enable_diff:
                ...
                # Apply correct style based on which page is visible
